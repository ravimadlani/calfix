      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">
            ...
            <a href="mailto:privacy@calendarzero.com" className="text-indigo-600 hover:underline">
              privacy@calendarzero.com
            </a>
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <p className="text-gray-700">
              ...
              <a href="mailto:dpo@calendarzero.com" className="text-indigo-600 hover:underline">
                dpo@calendarzero.com
              </a>
            </p>
          </div>
        </section>
